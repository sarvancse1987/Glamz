...
using Glamz.Business.Checkout.Commands.Models.Shipping;
using Glamz.Business.Checkout.Extensions;
...
namespace Glamz.Business.Checkout.Commands.Handlers.Shipping
{
