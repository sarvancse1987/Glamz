...
using Glamz.Infrastructure.Caching.RabbitMq;
using Glamz.Infrastructure.Configuration;
using Glamz.Infrastructure.Mapper;
using Glamz.Infrastructure.Plugins;
using Glamz.Infrastructure.Roslyn;
using Glamz.Infrastructure.TypeConverters;
...
namespace Glamz.Infrastructure
{
    ...
    public static class StartupBase
    {
        ...
        private static IMvcCoreBuilder RegisterApplication(IServiceCollection services, IConfiguration configuration)
        {
            ...
            //add wkhtmltopdf
            //services.AddWkhtmltopdf();//Commented Rubix
            ...
            //add Glamz.web api token config
